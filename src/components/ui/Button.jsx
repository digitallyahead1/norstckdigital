...
export function Button({
  ...
  return (
    <motion.button
      ...
      className={`group relative inline-flex items-center justify-between gap-6 rounded-xl px-6 py-3.5 text-xs font-bold uppercase tracking-[0.15em] transition-all duration-500 ease-lux ${isPrimary ? 'bg-brand-gold text-white hover:opacity-95 shadow-md' : 'border border-brand-border1 bg-transparent text-brand-text1 hover:border-brand-border2 hover:bg-brand-surface1'} ${className}`}
      {...props}>
