          ...
          >
            ...
            <div className="space-y-6 mb-16">
              ...
              <a
                ...
                className="flex items-center p-6 bg-brand-surface1 border border-[#25D366]/30 rounded-2xl cursor-pointer hover:border-[#25D366]/60 transition-colors group"
              >
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-11 h-11 rounded-xl bg-brand-surface1 border border-brand-border1 flex items-center justify-center text-brand-text2 hover:text-[#25D366] hover:border-[#25D366]/50 transition-all duration-300"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
